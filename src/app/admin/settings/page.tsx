...
export default function SettingsPage() {
  ...
  const [systemStatus, setSystemStatus] = useState<{ cloudinary: boolean }>({
    cloudinary: false,
  });
          ...
          <div className="flex flex-col gap-6">
            <div className="flex-1">
              ...
              <p className="text-white/30 text-sm leading-relaxed max-w-md">
                Upload or link the main hero video for the homepage using
                Cloudinary.
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="w-full md:w-1/3 flex flex-col gap-4">
                <div>
                  <label className="block text-[10px] uppercase font-black tracking-widest text-white/40 mb-2 pl-1">
                  ...
                  <input
                    ...
                    onBlur={(e) =>
                      handleUpdate("hero_video_url", e.target.value)
                    }
                    placeholder="https://..."
